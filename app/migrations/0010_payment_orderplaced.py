    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accpeted', 'Accpeted'), ('Packed', 'Packed'), ('On The Way', 'On The Way'), ('Accpeted', 'Accpeted'), ('Cancel', 'Cancel'), ('Pending', 'Pending')], default='pending', max_length=50)),
