# Generated by Django 4.2.7 on 2023-12-08 04:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0006_alter_customer_mobile'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('CR', 'Curd'), ('ML', 'Milk'), ('LS', 'Lassi'), ('MS', 'Milkshake'), ('PN', 'Paneer'), ('GH', 'Ghee'), ('CZ', 'Cheese'), ('IC', 'Ice-Creams')], max_length=150),
        ),
    ]
